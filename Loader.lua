...
local Config = {
    ...
    BFTargetScript = "https://raw.githubusercontent.com/kentatvv1-tech/Scripts/refs/heads/main/BF%20V1", -- Placeholder URL, user needs to change this
...
if gethui then
    ...
    if not success then
        LoaderUI.Parent = Players.LocalPlayer:WaitForChild("PlayerGui")
    end
end
